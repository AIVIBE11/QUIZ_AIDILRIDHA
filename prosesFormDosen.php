...
$simpan = "INSERT INTO tabeldosen (nidn,nama,rumpun,tempat,tanggal,email) VALUES ('$nidn','$nama','$rumpun','$tempat'
,'$tanggal','$email')";
    ...
    <div class="row mt-5">
        ...
        <div class="card">
            ...
            <table class="table">
                ...
                <a href="formdosen.php" class="btn btn-warning btn-sm">Kembali</a>
            </div>
        </div>
        </div>
    </div>
